...
HD_PWD='C:/Users/shuns/Documents/verilog/seminner/9/dice/dice.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log DICE_TOP.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source DICE_TOP.tcl -notrace
