...
HD_PWD='C:/Users/shuns/Documents/verilog/seminner/9/dice/dice.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log DICE_TOP.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source DICE_TOP.tcl
