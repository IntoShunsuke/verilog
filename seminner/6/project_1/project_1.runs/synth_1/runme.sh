...
HD_PWD='C:/Users/shuns/Documents/verilog/seminner/6/project_1/project_1.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log aho.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source aho.tcl
