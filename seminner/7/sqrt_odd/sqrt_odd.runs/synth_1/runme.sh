...
HD_PWD='C:/Users/shuns/Documents/verilog/seminner/7/sqrt_odd/sqrt_odd.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log sqrt_odd.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source sqrt_odd.tcl
